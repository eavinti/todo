...
class TaskRepository:
    ...
    def save(self, task: Task):
        ...
        db_task = TaskORM(title=task.title, description=task.description, completed=task.completed)
    ...
    def _to_task(self, task_orm: TaskORM) -> Task:
        ...
        return Task(title=task_orm.title, description=task_orm.description, completed=task_orm.completed)
